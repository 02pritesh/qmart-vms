...
<style>
   .block {
    ...
    <a href="{{url('vendor-detail')}}" class="btn-submit ml-3" style="text-decoration: none; padding:4px 14px;"><i class="fa-solid fa-left-long"></i></a>
    <div class="container block mt-4 mb-4">
      <form action="{{url('edit-vendor-detail')}}" method="POST">
        @csrf
        <div class="row">
