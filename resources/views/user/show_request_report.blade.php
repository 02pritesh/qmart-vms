...
@endif
  ...
  @if(session('error'))
    ...
    @endif
     <!--<a href="{{url('user-dashboard')}}" class="btn-submit btn-reply ml-3" style="text-decoration: none; padding:8px 8px;">Back</a>-->
                                    ...
                                    @foreach ($messages as $message)
                                        <tr>
                                            ...
                                            <td class="message-wrap" id="admin_message_{{ $i }}">{{ $message['admin_message']}}</td>
                                             <th scope="col">{{ $message->approved_by}}</th>
                                           
                                            
                                            <!--<td>-->
                                            <!--    <a href="{{ asset('public/assets/upload/' .$message['vendor_file'])}}" class="btn-view" download><b>Download</b></a>-->
                                            <!--</td>-->
                                            <td>
                                                <b>{{ $message->status}}</b>
                                            </td>
