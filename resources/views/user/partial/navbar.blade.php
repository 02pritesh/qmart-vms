...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  ...
  <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
    ...
    if ($currentPath == 'vendor-detail') {
        $pageTitle = 'Registration';
    } elseif ($currentPath == 'user-dashboard') {
        $pageTitle = 'Dashboard';
    } elseif ($currentPath == 'vendor-show-vendor-registration-detail') {
        ...
        $pageTitle = 'Debit/Credit Note';
    } elseif ($currentPath == 'vendor-registration') {
        $pageTitle = 'Vendor Registration';
    }elseif ($currentPath == 'edit-user-registration') {
        $pageTitle = 'Update User Registration';
...
@endif
    ...
    <ul class="navbar-nav navbar-nav-right">
      <li class="nav-item nav-profile dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
          <a class="dropdown-item"  href="{{url('edit-user-registration')}}">
