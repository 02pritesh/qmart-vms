<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item">
        <a class="nav-link" data-toggle="" href="{{url('vendor-show-vendor-registration-detail')}}" aria-expanded="false"
    ...
    <li class="nav-item">
        <a class="nav-link" data-toggle="" href="{{url('vendor-show-sku-registration-detail')}}" aria-expanded="false"
              aria-controls="ui-basic">
              <i class="typcn typcn-document-text menu-icon"></i>
      ...
      <li class="nav-item">
        <!--<a class="nav-link" data-toggle="" href="{{url('show-request-report')}}" aria-expanded="false"-->
        <!--    aria-controls="form-elements">-->
        <a class="nav-link" data-toggle="" href="{{url('vendor-show-request-report-registration-detail')}}" aria-expanded="false"
            aria-controls="form-elements">
    ...
    <li class="nav-item">
        <a class="nav-link" data-toggle="" href="{{url('vendor-show-credit-detail')}}" aria-expanded="false"
              aria-controls="ui-basic">
    ...
    <li class="nav-item">
        <a class="nav-link" data-toggle="" href="{{url('vendor-show-payment-detail')}}" aria-expanded="false"
              aria-controls="ui-basic">
