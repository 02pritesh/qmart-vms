                            ...
                            <table class="table table-striped" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($users as $item)
                                        <tr onclick="window.location='{{ url('show-vendor-registration/' . $item->id) }}'"
                                    ...
                                    @foreach ($skuRegistrations as $item)
                                        <tr onclick="window.location='{{ url('show-sku-registration/' . $item->id) }}'"
                                            style="cursor:pointer;">
                                            <!--<td></td>-->
                                            <td>{{ \Carbon\Carbon::parse($item['created_at'])->format('Y-m-d') }}</td>
                                            <td>{{ $item['vendor_name'] }}</td>
                                    ...
                                    @foreach ($requestReports as $item)
                                        <tr onclick="window.location='{{ url('vendor-show-message/' . $item->id) }}'"
                                            style="cursor:pointer;">
                                            <!--<td></td>-->
                                            <td>{{ \Carbon\Carbon::parse($item['created_at'])->format('Y-m-d') }}</td>
                                            <td>{{ $item['vendor_name'] }}</td>
                                    ...
                                    @foreach ($innvoices as $item)
                                        <tr onclick="window.location='{{ url('vendor-show-innvoices-message/' . $item->id) }}'"
                                            style="cursor:pointer;">
                                            <!--<td></td>-->
                                            <td>{{ \Carbon\Carbon::parse($item['created_at'])->format('Y-m-d') }}</td>
                                            <td>{{ $item['vendor_name'] }}</td>
                                    ...
                                    @foreach ($debits as $item)
                                        <tr onclick="window.location='{{ url('vendor-show-credit-message/' . $item->id) }}'"
                                            style="cursor:pointer;">
                                            <!--<td></td>-->
                                            <td>{{ \Carbon\Carbon::parse($item['created_at'])->format('Y-m-d') }}</td>
                                            <td>{{ $item['vendor_name'] }}</td>
                                    ...
                                    @foreach ($payments as $item)
                                        <tr onclick="window.location='{{ url('vendor-show-payment-message/' . $item->id) }}'"
                                            style="cursor:pointer;">
                                            <!--<td></td>-->
                                            <td>{{ \Carbon\Carbon::parse($item['created_at'])->format('Y-m-d') }}</td>
                                            <td>{{ $item['vendor_name'] }}</td>
