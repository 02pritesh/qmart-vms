...
@section('user-content')
    ...
    @endif
      ...
      <a href="{{url('vendor-show-payment-detail')}}" class="btn-submit ml-3" style="text-decoration: none; padding:4px 14px;"><i class="fa-solid fa-left-long"></i></a>
                    ...
                    <label for="" ><b>File</b></label><br>  
                     ...
                     @if ($messages->admin_file)
                        ...
                        @else
                            ...
                            <a href="{{ asset('public/assets/upload/payment' . $messages->admin_file) }}" class="btn-submit" style="text-decoration:none; font-size:12px;" target="_blank" download>View Uploaded File</a>
                        @endif
                    @else
