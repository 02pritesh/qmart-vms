            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="unit" readonly>
...
{{-- 
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $skuDetail->cess_percentage }}" readonly>
                        @error('cess')
                            <span style="color: red;">{{ $message }}</span>
                        @enderror
                    </div>
        ...
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                function calculateValues() {
                    ...
                    $('#gstPrice').val(gst.toFixed(2));

                    // Calculate Basic Cost
                    var basicCost = landingPrice - gst;
                    $('#basicCost').val(basicCost.toFixed(2));
                }

                $('#gstPercentage, #marginPercentage, #mrp').on('input', calculateValues);
            });
